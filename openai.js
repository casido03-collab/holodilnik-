...
const STYLE_PROMPTS = {
  ...
  kids:     'простые и весёлые рецепты для детей (безопасные ингредиенты, интересные названия, дети едят с удовольствием)'
}
  ...
  "recipes": [
    {
      ...
      "emoji": "🍳",
      "servings": 2,
      "ingredients": ["Продукт 1 — количество", "Продукт 2 — количество"],
      "steps": ["Шаг 1: ...", "Шаг 2: ...", "Шаг 3: ..."],
      "nutrition": {"calories": 350, "protein": 12, "fat": 8, "carbs": 45},
      "cost": "~150 руб."
    }
  ]
}

Поля nutrition и cost обязательны — укажи примерные значения на одну порцию.
